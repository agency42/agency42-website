      ...
      >
        <div className="text-center text-black">
          ...
          <p className="mb-6 font-sans">
            We&apos;ve received your submission and will review it shortly. If
            your needs align with our expertise, we&apos;ll reach out to
    ...
    >
      <div className="grid grid-cols-1 gap-6 mb-6">
        <div>
          <Label
            htmlFor="companyName"
            className="font-mono text-[11px] tracking-wider uppercase text-black mb-2 block"
          >
            COMPANY NAME
          </Label>
          <Input
        ...
        <div>
          ...
          >
            <SelectTrigger
              id="companySize"
              className="w-full p-3 font-sans bg-white text-black border-2 border-black rounded-none focus:outline-none focus:ring-0 focus:border-black"
            >
      ...
      {submitError && (
        <div className="text-red-500 mb-4 text-sm font-sans">{submitError}</div>
      )}
      ...
      <p className="mt-4 text-xs text-black text-center font-sans">
        ...
        <Link
          href="/legal/privacy"
          className="underline hover:text-black text-black"
        >
          Privacy Policy
        </Link>
        .
