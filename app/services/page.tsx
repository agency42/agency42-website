    ...
    <div className="min-h-screen bg-base-light text-base-dark pt-24">
          ...
          <div className="md:grid md:grid-cols-2 gap-16 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-heading font-medium mb-6">
                AI Solutions That <span className="text-accent-start">Deliver</span> Real Results
              </h1>
            ...
            <div className="relative w-full aspect-square mt-8 md:mt-0">
              ...
              <div className="w-full h-full bg-neutral-200 flex items-center justify-center">
                <p className="text-neutral-400 font-mono">[Service Illustration]</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="md:grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              ...
              <div className="mb-6">
                <p className="font-mono text-sm text-accent-start mb-2">STARTING AT $4K</p>
              </div>
              <p className="mb-4">
              ...
              <h3 className="font-mono text-[11px] tracking-wider mt-8 mb-4 uppercase">What You Get</h3>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <span className="text-accent-start mr-2">✓</span>
            ...
            <div className="order-1 md:order-2 mb-8 md:mb-0">
              ...
              <div className="w-full aspect-video bg-neutral-200 flex items-center justify-center">
                <p className="text-neutral-400 font-mono">[Audit Process Image]</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="md:grid md:grid-cols-2 gap-16 items-center">
            <div className="mb-8 md:mb-0">
              {/* Placeholder for image */}
              <div className="w-full aspect-video bg-neutral-200 flex items-center justify-center">
                <p className="text-neutral-400 font-mono">[Workshop Image]</p>
              </div>
            </div>
            <div>
              <h2 className="text-3xl md:text-4xl font-heading font-medium mb-6">
              ...
              <div className="mb-6">
                <p className="font-mono text-sm text-accent-start mb-2">CUSTOM PRICING</p>
              </div>
              <p className="mb-4">
              ...
              <h3 className="font-mono text-[11px] tracking-wider mt-8 mb-4 uppercase">What's Included</h3>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <span className="text-accent-start mr-2">✓</span>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="md:grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              ...
              <div className="mb-6">
                <p className="font-mono text-sm text-accent-start mb-2">FROM $8K/MONTH</p>
              </div>
              <p className="mb-4">
              ...
              <h3 className="font-mono text-[11px] tracking-wider mt-8 mb-4 uppercase">Services Provided</h3>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <span className="text-accent-start mr-2">✓</span>
            ...
            <div className="order-1 md:order-2 mb-8 md:mb-0">
              {/* Placeholder for image */}
              <div className="w-full aspect-video bg-neutral-200 flex items-center justify-center">
                <p className="text-neutral-400 font-mono">[Retainer Service Image]</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-24 px-4 bg-neutral-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Audit Pricing */}
            <div className="p-8 bg-white border border-neutral-200 flex flex-col">
              <h3 className="font-heading text-2xl mb-2">AI Opportunity Audit</h3>
              <p className="text-3xl font-heading font-medium text-accent-start mb-6">$4,000 - $8,000</p>
              <p className="font-light text-neutral-600 mb-6 flex-grow">
                Comprehensive analysis and action plan tailored to your business. Price varies based on company size and complexity.
              </p>
              <p className="font-mono text-[11px] tracking-wider mb-4">TIMELINE: 2-3 WEEKS</p>
              <Link
                href="#contact"
                className="inline-block w-full text-center bg-black text-white font-mono text-[11px] tracking-wider py-3 hover:bg-accent-start transition-colors"
              >
                GET STARTED
              </Link>
            </div>
            ...
            <div className="p-8 bg-white border border-neutral-200 flex flex-col">
              ...
              <p className="text-3xl font-heading font-medium text-accent-start mb-6">Custom Pricing</p>
              <p className="font-light text-neutral-600 mb-6 flex-grow">
              ...
              <p className="font-mono text-[11px] tracking-wider mb-4">TIMELINE: 1-3 DAYS</p>
              <Link
                href="#contact"
                className="inline-block w-full text-center bg-black text-white font-mono text-[11px] tracking-wider py-3 hover:bg-accent-start transition-colors"
              >
            ...
            <div className="p-8 bg-white border border-neutral-200 flex flex-col">
              ...
              <p className="text-3xl font-heading font-medium text-accent-start mb-6">From $8,000/mo</p>
              <p className="font-light text-neutral-600 mb-6 flex-grow">
                Ongoing strategic guidance and implementation support. Flexible engagement models to match your organization's needs.
              </p>
              <p className="font-mono text-[11px] tracking-wider mb-4">MIN. COMMITMENT: 3 MONTHS</p>
              <Link
                href="#contact"
                className="inline-block w-full text-center bg-black text-white font-mono text-[11px] tracking-wider py-3 hover:bg-accent-start transition-colors"
              >
      ...
      <section id="contact" className="py-24 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          {/* Placeholder for the Qualification Form */}
          <div className="p-8 bg-neutral-50 border border-neutral-200 text-left">
            <p className="text-center font-mono text-sm mb-8">
              QUALIFICATION FORM PLACEHOLDER<br />
              (To be replaced with the Resend form component)
            </p>
            <div className="grid grid-cols-1 gap-6 mb-6">
              <div>
                <label className="block font-mono text-[11px] tracking-wider mb-2">COMPANY NAME</label>
                <input type="text" className="w-full p-3 border border-neutral-300" disabled />
              </div>
              <div>
                <label className="block font-mono text-[11px] tracking-wider mb-2">YOUR NAME</label>
                <input type="text" className="w-full p-3 border border-neutral-300" disabled />
              </div>
              <div>
                <label className="block font-mono text-[11px] tracking-wider mb-2">EMAIL ADDRESS</label>
                <input type="email" className="w-full p-3 border border-neutral-300" disabled />
              </div>
              <div>
                <label className="block font-mono text-[11px] tracking-wider mb-2">COMPANY SIZE</label>
                <select className="w-full p-3 border border-neutral-300" disabled>
                  <option>Select an option</option>
                </select>
              </div>
              <div>
                <label className="block font-mono text-[11px] tracking-wider mb-2">BUDGET RANGE</label>
                <select className="w-full p-3 border border-neutral-300" disabled>
                  <option>Select an option</option>
                </select>
              </div>
              <div>
                <label className="block font-mono text-[11px] tracking-wider mb-2">PROJECT DESCRIPTION</label>
                <textarea className="w-full p-3 border border-neutral-300 h-32" disabled></textarea>
              </div>
            </div>
            <button 
              className="w-full bg-black text-white font-mono text-[11px] tracking-wider py-4 opacity-50 cursor-not-allowed"
              disabled
            >
              SUBMIT INQUIRY
            </button>
