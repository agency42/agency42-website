...
export const metadata: Metadata = {
  ...
  description:
    "Meet the Agency42 co-founders: We partner with companies to turn AI ambitions into real-world advantages that define industry standards.",
  keywords: [
    // Core positioning
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/logos/agency42.png",
        width: 1200,
        height: 630,
        alt: "Agency42 Company - Meet the Team",
      },
    ],
  },
  twitter: {
    ...
    <div className="min-h-screen bg-white text-black pt-24">
      <main className="container mx-auto max-w-6xl px-4 py-16">
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-white border border-black flex flex-col text-center rounded-md">
              ...
              <h3 className="font-heading text-xl mb-1 text-black">
                Ken Cavanagh
              </h3>
              <p className="font-mono text-[11px] tracking-wider text-black mb-4 uppercase">
                CEO & Co-Founder
              </p>
              <div className="font-sans text-sm leading-relaxed flex-grow text-gray-700 text-left">
                <p className="mb-3">
                  A strategist specializing in the human side of AI, Ken uses
                  his background in industrial psychology to build systems
                  people actually want to use.
                </p>
                <p className="mb-3">
                  <strong>Philosophy:</strong> "Agency, not just automation."
                  Believes in building capabilities, not dependencies.
                </p>
                <p>
                  <strong>Expertise:</strong> AI Strategy, Workflow Automation,
                  AI Agents, AI Education & Adoption.
                </p>
              </div>
            </div>
            ...
            <div className="p-8 bg-white border border-black flex flex-col text-center rounded-md">
              ...
              <div className="font-sans text-sm leading-relaxed flex-grow text-gray-700 text-left">
                <p className="mb-3">
                  An architect of scalable AI platforms, Rob brings a decade of
                  senior engineering experience to build robust,
                  production-grade systems.
                </p>
                <p className="mb-3">
                  <strong>Approach:</strong> "Principled innovation, scalable
                  engineering." Turns structured experiments into robust,
                  production-grade systems.
                </p>
                <p>
                  <strong>Expertise:</strong> Scalable Architecture, Platform
                  Engineering, Enterprise Integration, Technical Leadership.
                </p>
              </div>
            </div>
            ...
            <div className="p-8 bg-white border border-black flex flex-col text-center rounded-md">
              ...
              <p className="font-mono text-[11px] tracking-wider text-black mb-4 uppercase">
                Lead AI Developer & Co-Founder
              </p>
              <div className="font-sans text-sm leading-relaxed flex-grow text-gray-700 text-left">
                <p className="mb-3">
                  A developer and content creator, Saint{" "}
                  <Link
                  ...
                  on vibe coding and building AI marketing automation, merging
                  deep technical skill with strategies for cultural impact.
                </p>
                <p className="mb-3">
                  <strong>Method:</strong> "Learn by building." Focuses on
                  hands-on creation and sharing the process to teach and
                  inspire.
                </p>
                <p>
                  <strong>Expertise:</strong> AI Development, Content
                  Engineering, Viral Marketing, Agent-Based Systems.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="text-center">
          <div
            className="bg-white border-2 border-black rounded-lg p-8 shadow-lg max-w-4xl mx-auto"
            style={{ boxShadow: "8px 8px 0px 0px rgba(0,0,0,1)" }}
          >
            <h3 className="font-heading text-2xl md:text-3xl font-medium mb-4 text-black">
              Ready to partner with us?
            </h3>
            <p className="font-sans text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
              Let's discuss how our team can help you bring your AI vision to
              life.
            </p>
            <Link
