    ...
    return (
        <div className="min-h-screen bg-background text-foreground pt-24">
            <main className="container mx-auto max-w-5xl px-4 py-16">
                <h1 className="text-4xl md:text-6xl font-heading font-extrabold mb-4 text-center">Our Work</h1>
                <p className="text-lg text-gray-700 mb-10 text-center font-sans">Selected projects showcasing applied AI.</p>
